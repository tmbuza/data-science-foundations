...
Open or create a `.ipynb notebook`, then select the Python interpreter from the project’s `.venv` environment as the notebook kernel.
...
You do not need the public repository to follow this online guide. If you prefer to use CDI’s prepared project files, open the [Data Science Foundations GitHub repository](https://github.com/tmbuza/data-science-foundations).
